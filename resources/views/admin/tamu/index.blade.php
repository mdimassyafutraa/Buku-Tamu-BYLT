        ...
        <div class="pt-10">
            ...
            <div class="flex justify-between items-center gap-2">
                <a href="{{ route('formTamu') }}"
                    ...
                    <span class="text-sm hidden sm:inline">Tamu</span>
                </a>
                <form action="{{ route('admin.tamu') }}" method="GET">
                    ...
                    <tbody>
                        @foreach ($tamu as $index => $tamus)
                            <tr class="bg-white border-b-2">
                                <td class="p-3 text-sm text-gray-700">{{ $itemNumber + $index }}</td>
                                ...
                                <td class="p-3 text-lg">
                                    <form action="{{ route('admin.tamu.update-status', $tamus->id) }}" method="POST">
                                        @csrf
                                        @method('PUT')
