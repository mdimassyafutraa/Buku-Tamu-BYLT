...
@section('content')
    ...
    <section class="bg-gray-50">
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            ...
            <h2 class="font-bold text-biru text-2xl mb-6 italic">UPT Balai Yasa <span class="text-secondary">Lahat</span></h2>
            <div class="w-full bg-white rounded-lg shadow  md:mt-0 sm:max-w-md xl:p-0 ">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8 ">
                    <h1 class="text-xl font-bold leading-tight tracking-tight text-biru md:text-2xl uppercase">
                        Daftar
                    </h1>
                    @if (session('error'))
                    ...
                    <form class="space-y-4 md:space-y-6" action="{{ route('register') }}" method="POST">
                        @csrf
                        <div>
                            <label for="nama" class="block mb-2 text-sm font-medium text-biru ">Nama</label>
                        ...
                        <div>
                            <label for="email" class="block mb-2 text-sm font-medium text-biru ">Email</label>
                        ...
                        <div>
                            <label for="password" class="block mb-2 text-sm font-medium text-biru ">Password</label>
                        ...
                        <button type="submit" id="submit-link"
                            class="w-full text-white bg-primary hover:bg-opacity-80 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Daftar</button>
