            ...
            <div class="w-full bg-white rounded-lg shadow  md:mt-0 sm:max-w-md xl:p-0 ">
                <div class="p-6  sm:p-8 space-y-4 md:space-y-6">
                    ...
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        <button type="submit"
                            class="w-full text-white bg-primary hover:bg-opacity-80 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mt-4">Kirim
