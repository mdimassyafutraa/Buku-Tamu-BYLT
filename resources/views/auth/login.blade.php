                    ...
                    <form class="space-y-4 md:space-y-6" action="{{ route('login') }}" method="POST">
                        ...
                        <div>
                            <a href="{{ route('password.request') }}"
                                class="text-sm text-primary underline hover:text-biru float-right">Lupa
                                Password?</a>
                        </div>
                        <button type="submit"
                            class="w-full text-white bg-primary hover:bg-opacity-80 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Masuk</button>
