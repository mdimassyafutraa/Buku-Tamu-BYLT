                ...
                <ul class=" w-full mt-10 text-biru font-semibold ">
                    <li class="mb-2">
                        <a href="{{ route('admin.dashboard') }}"
                            class="flex items-center text-base p-4 rounded-md hover:bg-biru hover:text-white space-x-2 transition duration-300 ease-in-ot {{ Request::is('admin.dashboard*') ? 'active' : '' }}">
                    ...
                    <li class="mb-2">
                        <a href="{{ route('admin.tamu') }}"
                            class="flex items-center text-base p-4 rounded-md hover:bg-biru hover:text-white  space-x-2 transition duration-300 ease-in-out {{ Request::is('admin.tamu*') ? 'active' : '' }}">
                    ...
                    <li class="mb-2">
                        <a href="{{ route('admin.rekap') }}"
                            class="flex items-center text-base p-4 rounded-md hover:bg-biru hover:text-white  space-x-2 transition duration-300 ease-in-out {{ Request::is('admin.rekap*') ? 'active' : '' }}">
                            <i class="fa-solid fa-book"></i>
                            <span>Rekap</span>
                        </a>
                    </li>
                    <li class="mb-2">
                        <a href="{{ route('admin.fomrkontak') }}"
                            class="flex items-center text-base p-4 rounded-md hover:bg-biru hover:text-white  space-x-2 transition duration-300 ease-in-out {{ Request::is('admin.rekap*') ? 'active' : '' }}">
